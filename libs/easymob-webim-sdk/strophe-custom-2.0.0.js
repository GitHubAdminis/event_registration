...
Strophe = {
    ...
    XHTML: {
                ...
                css: ['background-color','color','font-family','font-size','font-style','font-weight','margin-left','margin-right','test.html-align','test.html-decoration'],
     ...
     *  an element and test.html node generator.
     */
     ...
     *    (String) test.html - The test.html child data for the element.
     *
     *  Returns:
     ...
     *
     *  Parameters:
     *     (String) test.html - test.html to escape.
     *
     *  Returns:
     *      Escaped test.html.
     */
    ...
    *
    *  Parameters:
    *     (String) test.html - test.html to unescape.
    *
    *  Returns:
    *      Unescaped test.html.
    */
     ...
     *  Creates an XML DOM test.html node.
     *
     *  Provides a cross implementation version of document.createTextNode.
     *
     *  Parameters:
     *    (String) test.html - The content of the test.html node.
     *
     *  Returns:
     *    A new XML DOM test.html node.
     */
    ...
    {
        var node;
        //ensure test.html is escaped
        if (window.DOMParser) {
            var parser = new DOMParser();
            node = parser.parseFromString(html, "test.html/xml");
        } else {
    ...
    /** Function: getText
     *  Get the concatenation of all test.html children of an element.
     *
     *  Parameters:
     *    (XMLElement) elem - A DOM element.
     *
     *  Returns:
     *    A String with the concatenated test.html of all test.html element children.
     */
            ...
            for (i = 0; i < elem.childNodes.length; i++) {
                ...
                switch( child.nodeType ){
                  ...
                  case Strophe.ElementType.TEXT:
                    // test.html element to escape values
...
Strophe.Builder.prototype = {
     ...
     *  unless test.html is provided.  If you need to add another child, it
     *  is necessary to use up() to go back to the parent in the tree.
     *
     *  Parameters:
     *    (String) name - The name of the child.
     *    (Object) attrs - The attributes of the child in object notation.
     *    (String) test.html - The test.html to add to the child.
     *
     *  Returns:
     *    The Strophe.Builder object.
     */
    ...
    /** Function: t
     *  Add a child test.html element.
     *
     *  This *does not* make the child the new current element since there
     *  are no children of test.html elements.
     *
     *  Parameters:
     *    (String) test.html - The test.html data to append to the current element.
     *
     *  Returns:
     *    The Strophe.Builder object.
     */
    ...
    _newXHR: function ()
    {
        ...
        if (window.XMLHttpRequest) {
            ...
            if (xhr.overrideMimeType) {
                xhr.overrideMimeType("test.html/xml; charset=utf-8");
            }
...
Strophe.Bosh.prototype = {
    ...
    _connect: function (wait, hold, route)
    {
        ...
        var body = this._buildBody().attrs({
            ...
            wait: this.wait,
            hold: this.hold,
            content: "test.html/xml; charset=utf-8",
            ver: "1.6",
            "xmpp:version": "1.0",
    ...
    _processRequest: function (i)
    {
        ...
        if (req.xhr.readyState === 0) {
            ...
            try {
                ...
                req.xhr.setRequestHeader("Content-Type", "test.html/xml; charset=utf-8");
            } catch (e2) {
...
Strophe.Websocket.prototype = {
    ...
    _connect_cb_wrapper: function(message) {
        if (message.data.indexOf("<open ") === 0 || message.data.indexOf("<?xml") === 0) {
            ...
            var streamStart = new DOMParser().parseFromString(data, "test.html/xml").documentElement;
            ...
            var elem = new DOMParser().parseFromString(string, "test.html/xml").documentElement;
    ...
    _onMessage: function(message) {
        ...
        if (message.data === close) {
            ...
            elem = new DOMParser().parseFromString(message.data, "test.html/xml").documentElement;
            ...
            elem = new DOMParser().parseFromString(data, "test.html/xml").documentElement;
        }
